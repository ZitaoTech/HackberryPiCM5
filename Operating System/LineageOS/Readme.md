# Install LineageOS on HackberryPi_CM5
...
```Step1``` Download the Release Image for HackberryPi_CM5 on this [page](https://github.com/ZitaoTech/HackberryPiCM5/releases/tag/LineageOS_HackberryPi_CM5_V1.0)  
